...
class sortingAlgorithms {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println("The time taken for quickSort 1k int " + elapsedTime1);
		
		final long startTime2 = System.currentTimeMillis(); 
		quickSort(array10000, 0, 9999);
		final long elapsedTime2 = System.currentTimeMillis() - startTime2;
		System.out.println();
		System.out.println("The time taken for quickSort 10k int " + elapsedTime2);
		
		final long startTime3 = System.currentTimeMillis(); 
		quickSort(array100000, 0, 99999);
		final long elapsedTime3 = System.currentTimeMillis() - startTime3;
		System.out.println();
		System.out.println("The time taken for quickSort 100k int " + elapsedTime3);
		
		final long startTime4 = System.currentTimeMillis(); 
		shuffleQuickSort(array1000copy1);
		final long elapsedTime4 = System.currentTimeMillis() - startTime4;
		System.out.println();
		System.out.println("The time taken for enhancedQuickSort 1k int " + elapsedTime4);
		
		final long startTime5 = System.currentTimeMillis(); 
		shuffleQuickSort(array10000copy1);
		final long elapsedTime5 = System.currentTimeMillis() - startTime5;
		System.out.println();
		System.out.println("The time taken for enhancedQuickSort 10k int " + elapsedTime5);
		
		final long startTime6 = System.currentTimeMillis(); 
		shuffleQuickSort(array100000copy1);
		final long elapsedTime6 = System.currentTimeMillis() - startTime6;
		System.out.println();
		System.out.println("The time taken for enhancedQuickSort 100k int " + elapsedTime6);
