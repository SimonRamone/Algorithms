...
class sortingAlgorithms {
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println("The time taken for mergeSort 1k int " + elapsedTime1);
		
		final long startTime2 = System.currentTimeMillis(); 
		mergeSort(array10000);
		final long elapsedTime2 = System.currentTimeMillis() - startTime2;
		System.out.println();
		System.out.println("The time taken for mergeSort 10k int " + elapsedTime2);
		
		final long startTime3 = System.currentTimeMillis(); 
		mergeSort(array100000);
		final long elapsedTime3 = System.currentTimeMillis() - startTime3;
		System.out.println();
		System.out.println("The time taken for mergeSort 100k int " + elapsedTime3);
		
		final long startTime4 = System.currentTimeMillis(); 
		insertionSort(array1000copy1);
		...
		insertionSort(array100000copy1);
